...
# added support for LED and audio control with motion sensing
...
mixer.init()
mixer.music.load('/home/pi/CouchG/sample.mp3')
lastPlayTime = 0
minPlayDuration = 10 # 10 seconds
...
while (True):
    ...
    if takePicture:
        led.on()
        if time.time() - lastPlayTime > minPlayDuration:
